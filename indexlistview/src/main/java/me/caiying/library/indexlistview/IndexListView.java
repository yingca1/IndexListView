...
public class IndexListView extends ListView {
    ...
    public void bind(IndexScroller indexScroller) {
        this.mIndexScroller = indexScroller;
        this.mIndexScroller.bind(this);
    ...
    public boolean isFastScrollEnabled() {
        if (mIndexScroller != null) {
            return mIndexScroller.isShowing();
        } else {
    ...
    public void draw(Canvas canvas) {
        ...
        if (mIndexScroller != null) mIndexScroller.draw(canvas);
    }

    @Override
    public boolean onTouchEvent(MotionEvent ev) {
        if (mIndexScroller != null && mIndexScroller.onTouchEvent(ev)) return true;
